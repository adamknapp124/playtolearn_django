"""
Django settings for playtolearn project.
...
SECRET_KEY = 'django-insecure-c_@gjribpq$(gr$f159p+hyn1ca-h4+juyxxw7&7yb7pg$o+(#'
...
WSGI_APPLICATION = 'playtolearn.wsgi.application'
